...
import { useListTutors, getListTutorsQueryKey } from "@workspace/api-client-react";
...
export default function TutorsPage() {
  ...
  const { data: tutors, isLoading } = useListTutors(params, {
    query: { queryKey: getListTutorsQueryKey(params) },
  });
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row">
          ...
          <Select value={maxRate?.toString() || "any"} onValueChange={(v) => setMaxRate(v && v !== "any" ? parseInt(v) : undefined)}>
            ...
            <SelectContent>
              ...
              <SelectItem value="20">Up to $20/hr</SelectItem>
              <SelectItem value="40">Up to $40/hr</SelectItem>
              <SelectItem value="60">Up to $60/hr</SelectItem>
                  ...
                  <Card className="group h-full border-card-border shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5" data-testid={`tutor-card-${tutor.id}`}>
                    <CardContent className="flex h-full flex-col p-5">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="shrink-0 text-sm font-bold text-primary">${tutor.hourlyRate}/hr</span>
                      </div>
